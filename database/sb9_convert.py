...
newd["Sp1"]="" 
newd["Sp2"]="" 
newd["ra (degree)"]= np.nan
newd["dec (degree)"]= np.nan
...
for i,sysi in enumerate(dat["System Number"]):
    try:
        ...
        newd.loc[sysi,"ra (degree)"]=dat4.loc[sysi,"ra (degree)"]
        newd.loc[sysi,"dec (degree)"]=dat4.loc[sysi,"dec (degree)"]
