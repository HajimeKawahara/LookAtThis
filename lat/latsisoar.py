...
#    print(len(delta_midnight[nightmask]))
    ...
    dat=pd.read_csv("../database/sisoar/sisoar.txt",delimiter=",",comment="#")
#WDS,NAME,HIP,RA,DEC,date,TMP,PA,paerr,SEP,seperr,magdiff,TMP2,TMP3
    ...
    plt.title("Speckle imaging (SOAR)")
